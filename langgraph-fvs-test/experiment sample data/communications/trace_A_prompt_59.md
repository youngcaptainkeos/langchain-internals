...
- **Operations Logistics** (Path: Executive Communications → Executive Supervisor → Research Supervisor → Security Supervisor → Operations Supervisor → Operations Vendor Manager → Operations Logistics)
...
- **Operations Support** (Path: Executive Communications → Executive Supervisor → Research Supervisor → Security Supervisor → Operations Supervisor → Operations Vendor Manager → Operations Logistics → Operations Support)

### 🛡️ Feedback Vertex Set (FVS) Containment
- **FVS Nodes Selected**: Security Auditor, Executive Supervisor, Operations Support, Security Risk, Research Analyst
...
**Runtime τ_FVS:** 5  
**FVS nodes:** Security Auditor, Executive Supervisor, Operations Support, Security Risk, Research Analyst  
