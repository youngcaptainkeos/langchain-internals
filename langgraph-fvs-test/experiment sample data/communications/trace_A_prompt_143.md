...
- **Operations**: Operations Continuity, Operations Procurement, Operations Supervisor, Operations Support, Operations Vendor Manager
...
- **Operations Support** (Path: Executive Communications → Executive Supervisor → Operations Supervisor → Operations Continuity → Operations Support)
