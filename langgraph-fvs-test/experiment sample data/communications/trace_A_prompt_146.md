...
- **Operations Finance** (Path: Engineering Planner → Engineering QA → Security Auditor → Security Supervisor → Operations Supervisor → Operations Finance)
...
- **Executive Finance** (Path: Engineering Planner → Engineering QA → Security Auditor → Security Supervisor → Operations Supervisor → Executive Supervisor → Executive Finance)
...
- **Operations Vendor Manager** (Path: Engineering Planner → Engineering QA → Security Auditor → Security Supervisor → Operations Supervisor → Operations Finance → Operations Vendor Manager)
...
- **Research Analyst** (Path: Engineering Planner → Engineering QA → Security Auditor → Security Supervisor → Operations Supervisor → Executive Supervisor → Research Supervisor → Research Analyst)
...
- **Research Writer** (Path: Engineering Planner → Engineering QA → Security Auditor → Security Supervisor → Operations Supervisor → Executive Supervisor → Research Supervisor → Research Analyst → Research Writer)
- **Research Reviewer** (Path: Engineering Planner → Engineering QA → Security Auditor → Security Supervisor → Operations Supervisor → Executive Supervisor → Research Supervisor → Research Analyst → Research Writer → Research Reviewer)

### 🛡️ Feedback Vertex Set (FVS) Containment
- **FVS Nodes Selected**: Executive Supervisor, Operations Supervisor, Research Analyst, Security Supervisor, Engineering Supervisor, Security Risk
...
**Runtime τ_FVS:** 6  
**FVS nodes:** Executive Supervisor, Operations Supervisor, Research Analyst, Security Supervisor, Engineering Supervisor, Security Risk  
